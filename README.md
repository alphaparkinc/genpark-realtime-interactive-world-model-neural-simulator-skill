# genpark-realtime-interactive-world-model-neural-simulator-skill
...
> **GenPark AI Agent Skill** -- Real-time interactive world model neural simulator at 60 FPS (Oasis style)
